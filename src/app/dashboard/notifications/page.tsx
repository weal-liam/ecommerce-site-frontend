...
export default function Page(){
    const { notifications, clearNotifications, removeNotification } = getUser();
    ...
    return (
        <>
            <div className="p-6">
                ...
                <div>
                    <button onClick={clearNotifications} className="mt-4 bg-red-600 text-white px-4 py-2 rounded">Clear</button>
                </div>
